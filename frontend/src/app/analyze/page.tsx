        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-3 md:gap-6">
          <Card>
            <CardHeader className="text-center p-3 md:p-6">
              <div className="mx-auto w-8 h-8 md:w-12 md:h-12 bg-green-100 rounded-full flex items-center justify-center mb-2">
                <Search className="w-4 h-4 md:w-6 md:h-6 text-green-600" />
              </div>
              <CardTitle className="text-sm md:text-lg">Tải ảnh lên</CardTitle>
          ...
          <Card>
            <CardHeader className="text-center p-3 md:p-6">
              <div className="mx-auto w-8 h-8 md:w-12 md:h-12 bg-blue-100 rounded-full flex items-center justify-center mb-2">
                <Brain className="w-4 h-4 md:w-6 md:h-6 text-blue-600" />
              </div>
              <CardTitle className="text-sm md:text-lg">AI phân tích</CardTitle>
              <CardDescription className="text-xs md:text-sm">
          ...
          <Card>
            <CardHeader className="text-center p-3 md:p-6">
              <div className="mx-auto w-8 h-8 md:w-12 md:h-12 bg-emerald-100 rounded-full flex items-center justify-center mb-2">
                <TrendingUp className="w-4 h-4 md:w-6 md:h-6 text-emerald-600" />
              </div>
              <CardTitle className="text-sm md:text-lg">Nhận kết quả</CardTitle>
              <CardDescription className="text-xs md:text-sm">
        ...
        <Card className="bg-gradient-to-r from-green-50 to-emerald-50 border-green-200">
          <CardHeader className="p-3 md:p-6">
            <CardTitle className="flex items-center gap-2 text-green-800 text-sm md:text-lg">
              <Leaf className="w-3 h-3 md:w-5 md:h-5" />
              Mẹo để có kết quả phân tích tốt nhất
            </CardTitle>
          </CardHeader>
          <CardContent className="space-y-2 md:space-y-3 text-green-700 p-3 md:p-6 pt-0">

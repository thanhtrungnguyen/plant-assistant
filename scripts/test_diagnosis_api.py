...
def diagnose_plant(
    image_path: str, api_url: str = "http://localhost:5001"
...
Examples:
    ...
    parser.add_argument(
        "image_path", nargs="?", help="Path to the plant image to diagnose"
    )
    ...
    parser.add_argument(
        "--health-check", action="store_true", help="Only check if the API is healthy"
    )
